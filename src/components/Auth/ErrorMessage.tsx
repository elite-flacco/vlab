...
export const ErrorMessage: React.FC<ErrorMessageProps> = ({
  ...
  const getErrorDetails = (errorMessage: string) => {
    ...
    if (
      lowerError.includes("account with this email address already exists") ||
    ...
    // Email validation
    if (
      lowerError.includes("valid email address") ||
    ...
    if (
      lowerError.includes("password must") ||
      ...
      return {
        ...
        message: errorMessage,
        suggestion: hasDetailedRequirements
          ? "Please check that your password meets all requirements above."
    ...
    if (
      lowerError.includes("connection problem") ||
    ...
    if (
      lowerError.includes("check your email") ||
  ...
  return (
    <div className={`border rounded-lg p-4 ${colors.container} ${className}`}>
