  ...
  const handleCallback = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/github-oauth-exchange`,
        {
          method: "POST",
          headers: {
        ...
        <div className="text-center">
          ...
          {status === "success" && (
            <>
              ...
              <p className="text-foreground-dim">
                Your GitHub account has been linked. You can now create issues
                directly from your tasks.
              </p>
              {!window.opener && (
