...
type SettingsTab = 'profile' | 'password' | 'community';
...
export const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Tabs Navigation */}
      <div className="flex border-b border-foreground-dim/20 mb-6">
        <button
          onClick={() => setActiveTab('profile')}
          className={`px-4 py-3 flex items-center space-x-2 font-medium text-sm border-b-2 transition-colors ${
            activeTab === 'profile' 
              ? 'border-primary text-primary' 
              : 'border-transparent text-foreground-dim hover:text-foreground hover:border-foreground-dim/30'
          }`}
        >
