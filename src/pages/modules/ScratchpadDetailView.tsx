...
export const ScratchpadDetailView: React.FC = () => {
  ...
  if (notes.length === 0 && !isEditingList) {
    return (
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <button
                  ...
                  {editingNoteId === note.id ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={formatTagsInput(note.tags || [])}
                          onChange={(e) => {
                            const updatedNotes = notes.map(n => 
                              n.id === note.id ? { ...n, tags: parseTagsInput(e.target.value) } : n
                            );
                            setNotes(updatedNotes);
                          }}
                ...
                <div className="bg-blue-50 border-2 border-dashed border-blue-300 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={formatTagsInput(newNote.tags || [])}
                        onChange={(e) => setNewNote(prev => ({ ...prev, tags: parseTagsInput(e.target.value) }))}
